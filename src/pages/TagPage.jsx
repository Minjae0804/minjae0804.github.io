    ...
    <PageLayout>
      <div className="flex flex-col gap-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-stone-500 dark:text-stone-400">{ui.breadcrumb.tag}</span>
          <span className="text-stone-300 dark:text-stone-600 text-sm">/</span>
        ...
        <div className="flex items-baseline gap-3">
          ...
          <span className="text-sm text-stone-400 dark:text-stone-500">{posts.length}{ui.tag.postCount}</span>
        </div>
        {posts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-stone-400 gap-2">
            <p className="text-sm">{ui.tag.empty}</p>
